    ...
    const bullTops = [
      ...
      { date: "2016-07-31", value: 1862.76,  label: "Bull 3 Top\n1,881" },
      { date: "2021-08-31", value: 3079.83,  label: "Bull 4 Top\n3,199" },
    ];
    const bearBottoms = [
      { date: "2002-03-15", value: 186.22,  label: "Bear 1\n186" },
      { date: "2012-03-29", value: 299.0,   label: "Bear 2\n299" },
      { date: "2019-03-31", value: 1143.09, label: "Bear 3\n1,099" },
      { date: "2022-09-29", value: 1849.79, label: "Bear 4\n1,815" },
    ];

    // Bull cycle date ranges for background shading
    const bullCycles = [
      { start: "2000-01-01", end: "2000-11-23", label: "Bull 1", color: "rgba(78,205,196,0.13)" },
      ...
      { start: "2019-03-05", end: "2021-08-31", label: "Bull 4", color: "rgba(171,71,188,0.13)"  },
      { start: "2022-09-29", end: "2099-01-01", label: "Bull 5", color: "rgba(78,205,196,0.09)"  },
    ];
